  ...
  if (active && payload && payload.length) {
    return (
      <div className="bg-white border border-gray-200 rounded-lg px-3 py-2 shadow text-sm">
        ...
        <p className="text-green-700 font-bold">{payload[0].value.toLocaleString('fr-FR')} kcal</p>
      </div>
    );
  }
  return null;
...
export default function HistoryChart({ history }) {
  ...
  return (
    <div className="rounded-xl border border-gray-200 bg-white shadow-sm p-4 mb-6">
      <h2 className="text-sm font-medium text-gray-700 mb-4">Calories sur 7 jours</h2>
